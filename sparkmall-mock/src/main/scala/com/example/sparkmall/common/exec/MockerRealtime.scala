package com.example.sparkmall.common.exec


import java.util.Properties

import com.example.sparkmall.common.model.CityInfo
import com.example.sparkmall.common.util.{ConfigurationUtil, RanOpt, RandomOptions}
